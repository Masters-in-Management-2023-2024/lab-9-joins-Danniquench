...
Original file is located at
    https://colab.research.google.com/github/Masters-in-Management-2023-2024/lab-9-joins-Danniquench/blob/main/lab_example.ipynb
...
avg_bad_weather = (bad_weather_trips.select(pl.col("duration").mean().alias("avg_duration")))
...
hof_hits = (hof_stats.group_by("playerID").agg(pl.col("H").sum().alias("total_hits")).select(pl.col("total_hits").mean().alias("average_hits")))
